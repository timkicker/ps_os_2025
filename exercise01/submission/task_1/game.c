...
char get_single_neighbor_secure(int** field, int width, int height, int h_cell, int w_cell,
                                int h_neighbor, int w_neighbor) {

	if (h_cell + h_neighbor < 0 || h_cell + h_neighbor >= height || w_cell + w_neighbor < 0 ||
...
char get_neighbors(int** field, int width, int height, int h_cell, int w_cell) {
	...
	neighbors +=
	    get_single_neighbor_secure(field, width, height, h_cell, w_cell, -1, -1); // bottom left
	neighbors +=
	    get_single_neighbor_secure(field, width, height, h_cell, w_cell, -1, 0); // bottom middle
